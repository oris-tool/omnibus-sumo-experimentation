...
public class Table4PCSumoAnalyzer {

    private double[] availability;
    private double[] onQueueCars;

    public Table4PCSumoAnalyzer analyze(int flowIndex,
...
//                }
    ...
    private void configureEnvironment(int flowIndex) throws XPathExpressionException, ParserConfigurationException,
        ...
        Table4PCSumoConfigurator.changeRoadLenght(flowIndex);
        Table4PCSumoConfigurator.configureNetwork(flowIndex);
        Table4PCSumoConfigurator.configureVehicles(flowIndex);
    }
