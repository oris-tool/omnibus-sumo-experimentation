...
public class Table3PCSumoAnalyzer {

    private double[] availability;
    private double[] onQueueCars;

    public Table3PCSumoAnalyzer analyze(int flowIndex,
...
//                }
    ...
    private void configureEnvironment(int flowIndex) throws XPathExpressionException, ParserConfigurationException,
        ...
        Table3PCSumoConfigurator.changeRoadLenght(flowIndex);
        Table3PCSumoConfigurator.configureNetwork(flowIndex);
        Table3PCSumoConfigurator.configureVehicles(flowIndex);
    }
